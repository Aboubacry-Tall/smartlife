<div class="container" id="app-img">
	...
	<div class="text-center">
		<h1 class="display-4 indigo-text">CONTACTS-FAVORIS</h1>
	</div>
	<div class="row">
	...
	<?php foreach ($favoris as $favori): ?>
		<div class="w3-card-2 white animated zoomIn fast mb-2">
			<a href="contact-<?=$favori->id?>">
				<div class="w3-container">
					<div class="clearfix">
						<span class="float-left">
							<b class="btn btn-floating btn-indigo"><i class="fa fa-user mt-3"></i></b>
							<strong class="black-text"><?= $favori->nom ?></strong>
						</span>
						<span class="float-right mt-5">
							<strong class="mr-3 black-text"><?= $favori->numero ?></strong>
							<strong><?= $favori->email ?></strong>
						</span>
					</div>
				</div>
			</a>
