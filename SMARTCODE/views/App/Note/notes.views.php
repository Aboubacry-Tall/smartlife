<div class="container" id="app-img">
	<i class="fas fa-sticky-note fa-9x animated zoomInUp slower" id="icn"></i>
	<div class="text-center">
		<h1 class="display-4 indigo-text text-uppercase">Notes</h1>
	</div>
	<div class="clearfix">
...
<script type="text/javascript">
	function del(a){
		window.location.href = 'delete-notes-'+a;
	}
