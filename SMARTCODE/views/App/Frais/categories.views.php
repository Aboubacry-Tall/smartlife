<div class="container">
	<div class="text-center">
		<h1 class="display-4 indigo-text text-uppercase">catégorie de frais</h1>
	</div>
	...
	<div class="row">
		<?php if (isset($categories) && count($categories) != 0): ?>
			<?php foreach ($categories as $categorie): ?>
				<div class="col-3">
					<a href="categorie-<?= $categorie->id ?>-frais">
						<div class="card mt-2 mb-2 animated fadeInUp slow">
							<div class="card-body">
								<span><i class="fa fa-shopping-cart fa-2x indigo-text mr-3"></i></span>
